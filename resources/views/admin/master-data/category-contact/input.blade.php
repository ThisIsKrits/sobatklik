                        ...
                        @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-file">
                                    ...
                                    <img src="{{ asset('/dashboard/assets/img/icons/iconly/Plus-general.svg') }}" class="text-upload" alt=""  style="display: {{ $contact->icon ? 'none' : '' }};"/>
                                    <input type="file" name="logo" class="image"/>
                                    <img src="{{ $contact->icon ? asset('uploads/' . $contact->icon) : '' }}" alt="" class="show-image" style="display: {{ $contact->icon ? 'block' : 'none' }};"/>
                                    <p class="text-upload" style="display: {{ $contact->icon ? 'none' : '' }};">Upload</p>
                                    </div>
                                </div>
                            </div>
